		...
		"LaunchConfig": Resource{
			...
			Properties: map[string]interface{}{
				...
				"UserData": Fn("Base64", FnJoin("",
					...
					"sudo -u ubuntu curl -L -o /home/ubuntu/workspace/stemcell.tgz https://s3.amazonaws.com/bosh-warden-stemcells/bosh-stemcell-2776-warden-boshlite-ubuntu-trusty-go_agent.tgz\n",
					"sudo -u ubuntu curl -L -o /home/ubuntu/workspace/dummy.zip https://github.com/pivotal-cf-experimental/dummy-boshrelease/archive/master.zip\n",
					"sudo -u ubuntu unzip /home/ubuntu/workspace/dummy.zip -d /home/ubuntu/workspace \n",
					"sudo -u ubuntu rm /home/ubuntu/workspace/dummy.zip \n",
					"sudo -u ubuntu mv /home/ubuntu/workspace/dummy-boshrelease-master /home/ubuntu/workspace/dummy \n",
					"\n")),
			},
		},
